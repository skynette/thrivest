                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-8">
                                <div>
                                    <div>
                                        <h3 className="text-xl font-bold text-[#1e3a5f] mb-4 ">1. Investing in Resilience and Impact</h3>
                                        <p className="text-gray-700 leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">2. Gender Lens as a Growth Strategy</h3>
                                    <p className="text-gray-700 leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">3. Structured Growth and Sustainable Systems</h3>
                                    <p className="text-gray-700 leading-relaxed">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">4. Long-Term Capital, Strategic Partnership</h3>
                                    <p className="text-gray-700 leading-relaxed">
